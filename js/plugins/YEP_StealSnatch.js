...
DataManager.processStealNotetags1 = function(group) {
  var note1i = /<(?:STEAL I|STEAL ITEM)[ ](\d+):[ ](\d+)([%ï¼…])>/i;
  var note1w = /<(?:STEAL W|STEAL WEAPON)[ ](\d+):[ ](\d+)([%ï¼…])>/i;
  var note1a = /<(?:STEAL A|STEAL ARMOR)[ ](\d+):[ ](\d+)([%ï¼…])>/i;
  var note1g = /<(?:STEAL G|STEAL GOLD)[ ](\d+):[ ](\d+)([%ï¼…])>/i;
  var note1t = /<(?:STEAL)[ ](.*):[ ](\d+)([%ï¼…])>/i;
  for (var n = 1; n < group.length; n++) {
    var obj = group[n];
    ...
    for (var i = 0; i < notedata.length; i++) {
      ...
      if (line.match(note1i)) {
        ...
        var entry = this.processCreateStealItem(type, id, rate);
        obj.stealableItems.push(entry);
      } else if (line.match(/<(?:STEAL RESIST):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
...
DataManager.processStealNotetags2 = function(group) {
  for (var n = 1; n < group.length; n++) {
    ...
    for (var i = 0; i < notedata.length; i++) {
      ...
      if (line.match(/<(?:STEAL)>/i)) {
      ...
      } else if (line.match(/<(?:STEAL ITEM):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        obj.steal = 'steal';
        obj.stealType.push('item');
      ...
      } else if (line.match(/<(?:STEAL WEAPON):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        obj.steal = 'steal';
        obj.stealType.push('weapon');
      ...
      } else if (line.match(/<(?:STEAL ARMOR):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        obj.steal = 'steal';
        obj.stealType.push('armor');
      ...
      } else if (line.match(/<(?:STEAL GOLD):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        obj.steal = 'steal';
        obj.stealType.push('gold');
        ...
        obj.steal = 'snatch';
        obj.stealType = ['all'];
      } else if (line.match(/<(?:SNATCH):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        obj.steal = 'snatch';
        obj.stealType = ['all'];
        obj.stealRate['all'] = parseFloat(RegExp.$1) * 0.01;
        ...
        obj.steal = 'snatch';
        obj.stealType.push('item');
      } else if (line.match(/<(?:SNATCH ITEM):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        obj.steal = 'snatch';
        obj.stealType.push('item');
        obj.stealRate['item'] = parseFloat(RegExp.$1) * 0.01;
        ...
        obj.steal = 'snatch';
        obj.stealType.push('weapon');
      } else if (line.match(/<(?:SNATCH WEAPON):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        obj.steal = 'snatch';
        obj.stealType.push('weapon');
        obj.stealRate['weapon'] = parseFloat(RegExp.$1) * 0.01;
        ...
        obj.steal = 'snatch';
        obj.stealType.push('armor');
      } else if (line.match(/<(?:SNATCH ARMOR):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        obj.steal = 'snatch';
        obj.stealType.push('armor');
        obj.stealRate['armor'] = parseFloat(RegExp.$1) * 0.01;
        ...
        obj.steal = 'snatch';
        obj.stealType.push('gold');
      } else if (line.match(/<(?:SNATCH GOLD):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        obj.steal = 'snatch';
        obj.stealType.push('gold');
        obj.stealRate['gold'] = parseFloat(RegExp.$1) * 0.01;
...
DataManager.processStealNotetags4 = function(group) {
  for (var n = 1; n < group.length; n++) {
    ...
    for (var i = 0; i < notedata.length; i++) {
      ...
      } else if (line.match(/<(?:STEAL WEAPON RATE):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        var rate = parseFloat(RegExp.$1) * 0.01;
        obj.stealRateBonus[2] += rate;
      } else if (line.match(/<(?:STEAL ARMOR RATE):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        var rate = parseFloat(RegExp.$1) * 0.01;
        obj.stealRateBonus[3] += rate;
      } else if (line.match(/<(?:STEAL GOLD RATE):[ ]([\+\-]\d+)([%ï¼…])>/i)) {
        var rate = parseFloat(RegExp.$1) * 0.01;

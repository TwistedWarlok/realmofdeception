...
//=============================================================================
 /*:
 * @plugindesc v1.01 (Requires YEP_BattleEngineCore.js) Reveal HP Gauges
...
Sprite_Battler.prototype.createVisualHpGaugeWindow = function() {
		...
		if (BattleManager.isATB() && Imported.YEP_X_VisualATBGauge &&
...
Window_VisualHPGauge.prototype.isShowWindow = function() {
    ...
    if (Yanfly.Param.VHGAlwaysShow) return true;
...
Window_VisualHPGauge.prototype.drawCurrentAndMax = function(current, max, x, y,
    ...
    if (Yanfly.Param.VHGShowMax) {
      Window_VisualHPGauge.prototype.drawCurrentAndMax.call(this, current, max,
